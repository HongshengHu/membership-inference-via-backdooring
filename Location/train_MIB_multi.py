...
parser.add_argument('--trigger_size', default=10, type=int, help='trigger size')
parser.add_argument('--trigger_locate', default=436, type=int, help='start point of trigger')
